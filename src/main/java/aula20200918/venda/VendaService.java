...
public class VendaService {
	...
	public void incluirDadosIniciais() {
        ...
        //ItemPedido ip1 = new ItemPedido(p01Maria, fraldaPampersRN, new BigDecimal("2.00"), new BigDecimal("10.00"));
	...
	public Pedido recuperarPedidoPeloNúmero(long númeroDoPedido) {
        ...
        return query.setParameter("numero", númeroDoPedido).getSingleResult();
	}
